...
const APP = {
  ...
  // Elementos DOM (inicializados em init())
  modal: null,
  form: null,
  btnAdicionar: null,
  btnVerificar: null,
  ...
  themeToggle: null,
  dailyMessage: null,
  containerLembretes: null,
  countLembretes: null,
  modalVerificar: null,
  containerVerificar: null,
  closeVerificar: null,
  btnFecharVerificar: null,
  btnAtualizarModal: null,
  filtroSemana: null,
  filtroStatus: null,
  modalEditar: null,
  formEditar: null,
  ...
  init() {
    ...
    this.modal = document.getElementById('modalAdicionar');
    this.form = document.getElementById('formLembrete');
    ...
    this.dailyMessage = document.getElementById('dailyMessage');
    this.containerLembretes = document.getElementById('containerLembretes');
    this.countLembretes = document.getElementById('countLembretes');

    this.modalVerificar = document.getElementById('modalVerificar');
    this.containerVerificar = document.getElementById('containerVerificar');
    this.closeVerificar = document.getElementById('closeVerificar');
    this.btnFecharVerificar = document.getElementById('btnFecharVerificar');
    this.btnAtualizarModal = document.getElementById('btnAtualizarModal');
    ...
    this.closeEditar = document.getElementById('closeEditar');
    this.btnCancelarEditar = document.getElementById('btnCancelarEditar');

    // Agora inicializar o app
  ...
  async adicionarLembrete(e) {
    ...
    let dataCorrigida = dataInput;
    if (dataInput) {
      // A data vem como YYYY-MM-DD (ex: 2026-09-07)
